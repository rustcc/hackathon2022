...
const { items, showNewItemModal, currentItem, currentCategory, updateCategory, setCurrentItem, toggleFavorited, toggleDeleted } = $(box3Store())

const route = useRoute()
updateCategory(route.params.category)
