<template>
  <div class="bg-white py-16 relative overflow-hidden">
    <div class="hidden lg:h-full lg:w-full lg:inset-y-0 lg:block lg:absolute">
      <div class="h-full mx-auto max-w-prose text-lg relative" aria-hidden="true">
        <svg class="left-full transform top-12 translate-x-32 absolute" width="404" height="384" fill="none" viewBox="0 0 404 384">
          <defs>
        ...
        <svg class="right-full transform top-1/2 -translate-y-1/2 -translate-x-32 absolute" width="404" height="384" fill="none" viewBox="0 0 404 384">
          <defs>
        ...
        <svg class="left-full transform bottom-12 translate-x-32 absolute" width="404" height="384" fill="none" viewBox="0 0 404 384">
          <defs>
    ...
    <div class="px-4 relative sm:px-6 lg:px-8">
      <div class="mx-auto max-w-prose text-lg">
        <h1>
          <span class="font-semibold text-base text-center tracking-wide text-indigo-600 block uppercase">Introducing</span>
          <span class="font-extrabold mt-2 text-center tracking-tight text-3xl text-gray-900 leading-8 block sm:text-4xl">JavaScript for Beginners</span>
        </h1>
...
Aliquet nec orci mattis amet quisque ullamcorper neque, nibh sem. At arcu, sit dui mi, nibh dui, diam eget aliquam. Quisque id at vitae feugiat egestas ac. Diam nulla orci at in viverra scelerisque eget. Eleifend egestas fringilla sapien.
      ...
      <div class="mx-auto mt-6 text-gray-500 prose prose-indigo prose-lg">
        ...
        <figure>
          <img class="rounded-lg w-full" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&auto=format&fit=facearea&w=1310&h=873&q=80&facepad=3" alt="" width="1310" height="873" >
